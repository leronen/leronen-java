...
public class HClusterDistanceFunction_single_linkage<T> extends HClusterDistanceFunction<T> {
        
    
    public HClusterDistanceFunction_single_linkage() {
        super();
    }
    
    public HClusterDistanceFunction_single_linkage(IDistanceFunction<T> pBaseFunction) {                                                    
        super(pBaseFunction);               
    }
     ...
     * single existing object. Assume distances between pObj and the cluster' 
