...
public class MultiSplitLayout implements LayoutManager {
	...
	this.model = model;
        this.mDividerSize = UIManager.getInt("SplitPane.dividerSize"); 
     ...
     * @see #setDividerSize
     */
    public int getDividerSize() { return mDividerSize; }
	...
	int oldDividerSize = this.mDividerSize;
...
//	Node lastWeightedChild = split.lastWeightedChild();
   ...
   private void layout2(Node root, Rectangle bounds) {
	...
	/**
		 * 
		 */
		private static final long serialVersionUID = 1643235926967716227L;
	 ...
	 * @see #setParent
	 */
	public Split getParent() { return mParent; }
	...
	private List<Node> mChildren = Collections.emptyList();
	...
	public List<Node> getChildren() { 
	    return new ArrayList<Node>(mChildren);
	}
	...
	public void setChildren(List<Node> children) {
	    ...
	    this.mChildren = new ArrayList<Node>(children);
	    for(Node child : this.mChildren) {
