...
public class ColorUtils {
    ...
    public static <T> Map<T,Color> getColoring(Collection<T> pObjects) throws TooManyColorsRequestedException {
        ...
        if (CACHED_COLORS != null 
            ...
            return CollectionUtils.subMap(CACHED_COLORS, (Collection)(Object)pObjects, true);
        }
...
//    }
    ...
    public static List<Color> getForbiddenColors() {
        ArrayList result = new ArrayList(ReflectionUtils.getPublicStaticFieldsWithPrefix(ColorUtils.class, "DARKEST", true).values());
...
//        }
        ...
        Logger.dbg("Centroids:\n"+StringUtils.collectionToString((Collection<Color>)centroids, "\n", getFormatter()));
...
//        CACHED_COLORS = centroids;
    ...
    public static Map<Color, String> getColorToNameMap() {
        Map<String, Color> colorByString = (Map<String, Color>)(Map)ReflectionUtils.getPublicStaticFieldsWithPrefix(ColorUtils.class, "", true);        
...
//        int d_g = p1.getRed();
    ...
    private static void createAndShowGUI(String pTitle, Map<String, Color> pColorMap) {        
        ...
        for (String colorName: pColorMap.keySet()) {
        	Color color = (Color)pColorMap.get(colorName);
    ...
    public static void test1() throws Exception {
        ...
        javax.swing.SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                Map<String, Color> colorMap = (Map<String, Color>)(Map)ReflectionUtils.getPublicStaticFieldsWithPrefix(ColorUtils.class, "", true);
